...
public class MoveFigure {
	...
	/* ============================================ */
	public int moveLeft(GraphicalObject[] figs, int numFigures, int fignum, int step)
	/* ============================================ */
	/*
	...
	/* ============================================ */
	public int moveRight(GraphicalObject[] figs, int numFigures, int fignum, int step)
	/* ============================================ */
	/*
	...
	/* ============================================ */
	public int moveDown(GraphicalObject[] figs, int numFigures, int fignum, int step)
	/* ============================================ */
	/*
	...
	/* ============================================ */
	public int moveUp(GraphicalObject[] figs, int numFigures, int fignum, int step)
	/* ============================================ */
	/*
	 * Move the graphical object specified by the second argument to the right. Return true
	 * if the graphical object could move
