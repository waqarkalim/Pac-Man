...
public class Gui extends JFrame implements ActionListener, KeyListener {
	...
	GraphicalObject[] figs = new GraphicalObject[MAX_FIGURES]; // Figures are stored in this array
	...
	private void readFigures(String name) {
		...
		try {
			...
			while (buff != null) {
				...
				figs[numFigures] = new GraphicalObject(numFigures, width, height, type, new Location(x, y));
	...
	/* ======================================= */
	public void drawFigure(GraphicalObject f) {
		/* ======================================= */
	...
	/* ======================================= */
	public void eraseFigure(GraphicalObject f) {
		/* ======================================= */
	...
	/* =========================== */
	public GraphicalObject[] getFigures() {
		/* =========================== */
		return figs;
	}
