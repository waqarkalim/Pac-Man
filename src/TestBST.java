...
public class TestBST {
	...
	public static void main(String[] args) {
		...
		try {
			...
			else System.out.println("Test 4 failed cus not null");
		}
		catch(Exception e) {
			System.out.println("Test 4 failed cuz of exception");
		}
		...
		try {
			if (tree.find(tree.getRoot(), p).isLeaf()) {
				System.out.println("(39, 19) is a leaf node");
			}
			System.out.println("Starting Test 16 now ....");
			tree.remove(tree.getRoot(),p);
			System.out.println("Node removed");
			res = tree.successor(tree.getRoot(),new Location(39,19));
			System.out.println("The res value is (" + res.getLocation().xCoord() + ", " + res.getLocation().yCoord() + ")");
			...
			if (res.getLocation().compareTo(new Location(39,20)) != 0)
			    ...
			    if (res == null) System.out.println("Test 16 failed cuz res is null");
			    System.out.println("Test 16 passed");
			}
		}
		catch (Exception e) {
			System.out.println("Test 16 failed cuz of exception");
		}
